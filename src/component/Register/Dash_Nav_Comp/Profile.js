            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <div>
                    <button className="btn" type='button' data-bs-toggle="modal" data-bs-target="#editDetailModal">
                        <h5><i class="fa-solid fa-pen-to-square"></i> Edit</h5>
                    </button>
                </div>
            </div>
                        ...
                        <div className="modal-body">
                            ...
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name='name' value={editName} onChange={handleEvent} class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Gender</label>
                                    <div className='gender'>
                                        <input class="form-check-input" type="radio" name="gender" value="male" onChange={handleEventRadio} /> Male
                                        <input class="form-check-input" type="radio" name="gender" value="female" onChange={handleEventRadio}/> Female
                                        <input class="form-check-input" type="radio" name="gender" value="other" onChange={handleEventRadio}/> Other <br />
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Martail Status</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value={editCountry} onChange={handleEventCountry} name='country' id="exampleInputEmail1" aria-describedby="emailHelp" />
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">City</label>
                                    <input type="text" class="form-control" name='city' value={editCity} onChange={handleEventCity} id="exampleInputEmail1" aria-describedby="emailHelp" />
                                </div>
