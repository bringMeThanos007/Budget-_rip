                    ...
                    <div className="col-md-6" id='section_1'>
                        <div className="intro">
                            ...
                            <div className="numbers mx-3">
                                ...
                                <p><i class="fa-solid fa-check"></i> Successful Tours</p>
                            </div>
                            <div className="numbers mx-3">
                                <p><strong>2,000</strong></p>
                                <p><i class="fa-regular fa-face-smile"></i> Happy Tourist</p>
                            </div>
                            <div className="numbers mx-3">
                                <p><strong>120</strong></p>
                                <p><i class="fa-solid fa-earth-asia"></i> Place Explored</p>
                            </div>
                        </div>
                        </div>
