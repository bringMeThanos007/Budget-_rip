                    ...
                    <div className="container hotel_container">
                        <div className="row hotel_row">
                            ...
                            <div className="col-md-2 delhi_hotel my-2">
                                <Link to="/book_activity"><img src={rishikesh} alt="" /></Link>
                                <h6>Rishikesh  </h6>
                            </div>

                            {/* Card 1 */}
                            <div className="col-md-2 goa_hotel my-2">
                                <Link to="/book_activity"><img src={goa} alt="" /></Link>
                                <h6>Goa  </h6>
                            </div>

                            {/* Card 1 */}
                            <div className="col-md-2 mumbai_hotel my-2">
                                <Link to="/book_activity"><img src={rajasthan} alt="" /></Link>
                                <h6>Rajasthan </h6>
                            </div>

                            {/* Card 1 */}
                            <div className="col-md-2 jaipur_hotel my-2">
                                <Link to="/book_activity"><img src={manali} alt="" /></Link>
                                <h6>Manali</h6>
                            </div>

                            {/* Card 1 */}
                            <div className="col-md-2 kerala_hotel my-2">
                                <Link to="/book_activity"><img src={kerala} alt="" /></Link>
                                <h6>Kerala </h6>
                            </div>
                        </div>
